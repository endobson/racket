#;#;
#<<END
TR missed opt: unboxed-let-functions6.rkt 32:21 (car l) -- Non float complex value in complex arithmetic
...
TR opt: unboxed-let-functions6.rkt 28:51 0.0+0.0i -- unbox float-complex
...
TR opt: unboxed-let-functions6.rkt 31:15 0.0+1.0i -- unbox float-complex
