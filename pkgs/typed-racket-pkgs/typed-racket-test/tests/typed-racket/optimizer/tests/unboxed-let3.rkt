#;#;
#<<END
TR opt: unboxed-let3.rkt 27:12 1.0+2.0i -- unbox float-complex
TR opt: unboxed-let3.rkt 27:21 2.0+4.0i -- unbox float-complex
...
TR opt: unboxed-let3.rkt 30:11 2.0+4.0i -- unbox float-complex
