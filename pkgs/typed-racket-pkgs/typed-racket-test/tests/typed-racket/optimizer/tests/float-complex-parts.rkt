...
TR opt: float-complex-parts.rkt 20:11 1.0+2.0i -- unbox float-complex
TR opt: float-complex-parts.rkt 21:0 (imag-part 1.0+2.0i) -- complex accessor elimination
TR opt: float-complex-parts.rkt 21:11 1.0+2.0i -- unbox float-complex
TR opt: float-complex-parts.rkt 22:0 (real-part 1.0+2.0i) -- complex accessor elimination
TR opt: float-complex-parts.rkt 22:11 1.0+2.0i -- unbox float-complex
END
#<<END
1.0
2.0
