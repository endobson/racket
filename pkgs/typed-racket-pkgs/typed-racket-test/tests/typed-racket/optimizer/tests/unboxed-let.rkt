#;#;
#<<END
TR opt: unboxed-let.rkt 27:11 (+ 1.0+2.0i 2.0+4.0i) -- unboxed float complex: addition
TR opt: unboxed-let.rkt 27:14 1.0+2.0i -- unbox float-complex
TR opt: unboxed-let.rkt 27:23 2.0+4.0i -- unbox float-complex
...
TR opt: unboxed-let.rkt 28:17 3.0+6.0i -- unbox float-complex
TR opt: unboxed-let.rkt 28:7 (t2 (- t1 3.0+6.0i)) -- unboxed let bindings
TR opt: unboxed-let.rkt 29:11 4.0+8.0i -- unbox float-complex
TR opt: unboxed-let.rkt 29:7 (t3 4.0+8.0i) -- unboxed let bindings
TR opt: unboxed-let.rkt 30:2 (+ t2 t3) -- unboxed float complex: addition
