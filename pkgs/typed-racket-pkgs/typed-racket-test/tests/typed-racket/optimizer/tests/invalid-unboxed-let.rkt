...
TR opt: invalid-unboxed-let.rkt 23:10 (+ 1.0+2.0i 2.0+4.0i) -- unboxed float complex: addition
TR opt: invalid-unboxed-let.rkt 23:13 1.0+2.0i -- unbox float-complex
TR opt: invalid-unboxed-let.rkt 23:22 2.0+4.0i -- unbox float-complex
TR opt: invalid-unboxed-let.rkt 23:6 (t1 (+ 1.0+2.0i 2.0+4.0i)) -- unboxed let bindings
TR opt: invalid-unboxed-let.rkt 24:10 (+ 3.0+6.0i 4.0+8.0i) -- unboxed float complex: addition
TR opt: invalid-unboxed-let.rkt 24:13 3.0+6.0i -- unbox float-complex
TR opt: invalid-unboxed-let.rkt 24:22 4.0+8.0i -- unbox float-complex
TR opt: invalid-unboxed-let.rkt 27:11 (+ t1 t1) -- unboxed float complex: addition
