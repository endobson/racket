...
TR opt: unboxed-letrec-syntaxes+values.rkt 20:33 1.0+2.0i -- unbox float-complex
TR opt: unboxed-letrec-syntaxes+values.rkt 20:42 2.0+4.0i -- unbox float-complex
...
TR opt: unboxed-letrec-syntaxes+values.rkt 21:29 2.0+4.0i -- unbox float-complex
END
#<<END
5.0+10.0i
