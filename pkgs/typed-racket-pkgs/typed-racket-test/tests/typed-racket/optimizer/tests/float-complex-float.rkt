...
TR opt: float-complex-float.rkt 28:0 (- 1.0 2.0+4.0i 3.0+6.0i) -- unboxed binary float complex
...
TR opt: float-complex-float.rkt 30:0 (- 1.0+2.0i 2.0+4.0i 3.0) -- unboxed binary float complex
