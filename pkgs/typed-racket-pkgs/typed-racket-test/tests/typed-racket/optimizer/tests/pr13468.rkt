#;#;
#<<END
TR missed opt: pr13468.rkt 69:42 1 -- Non float complex value in complex arithmetic
TR missed opt: pr13468.rkt 72:5 (expt (ann -5.0 Flonum) (ann 2.0 Flonum)) -- unexpected complex type
TR opt: pr13468.rkt 67:13 6.0+2.3i -- unbox float-complex
TR opt: pr13468.rkt 67:5 (- (ann 6.0+2.3i Float-Complex)) -- unboxed float complex: subtraction
TR opt: pr13468.rkt 68:13 6.0+2.3i -- unbox float-complex
TR opt: pr13468.rkt 68:5 (/ (ann 6.0+2.3i Float-Complex)) -- unboxed float complex: division
TR opt: pr13468.rkt 69:13 0.0+0.0i -- unbox float-complex
TR opt: pr13468.rkt 69:42 1 -- non float complex in complex ops
TR opt: pr13468.rkt 69:5 (/ (ann 0.0+0.0i Float-Complex) (ann 1 Number)) -- unboxed float complex: division
END
#<<END
-6.0-2.3i
