...
TR missed opt: float-complex-sin.rkt 22:13 (sin (* t 6.28)) -- Non complex value in complex arithmetic
...
TR opt: float-complex-sin.rkt 22:13 (sin (* t 6.28)) -- non float complex in complex ops
