...
TR opt: unboxed-let-functions2.rkt 26:18 (+ x y) -- unboxed float complex: addition
TR opt: unboxed-let-functions2.rkt 26:21 x -- leave var unboxed
TR opt: unboxed-let-functions2.rkt 26:23 y -- leave var unboxed
TR opt: unboxed-let-functions2.rkt 27:17 2.0+4.0i -- unbox float-complex
...
TR opt: unboxed-let-functions2.rkt 27:5 (+ 1.0+2.0i 2.0+4.0i) -- unboxed float complex: addition
TR opt: unboxed-let-functions2.rkt 27:8 1.0+2.0i -- unbox float-complex
TR opt: unboxed-let-functions2.rkt 28:5 3.0+6.0i -- unbox float-complex
END
#<<END
6.0+12.0i
